      ...
      <div className="Sl_container">
        <div className="Sl_info">
          <div className="info_img">
            <img src="https://cube.elemecdn.com/e/64/d3681cf5b588a148e81691e3ebc3dpng.png?x-oss-process=image/format,webp/resize,w_130,h_130,m_fixed" />
          </div>
          <div className="info_main">
            ...
            <div className="info_star">
              ...
              <div className="ps">
                <span className="ps_1">准时达</span>
                <span className="ps_2">蜂鸟专送</span>
              </div>
            </div>
        ...
        <div className="Sl_activity">
          <div className="activity_tag">
            <span className="tag">咖啡</span>
            <span className="tag_rig">饿了么独家合作品牌</span>
          </div>

          <div className="activity_list">
            <div className="cut_main">
              <i className="cut">减</i>
              <span>满70减8，满100减15，满140减20</span>
            </div>
            <div className="fth_main">
              <i className="firt">首</i>
